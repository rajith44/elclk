...
$_['text_percentage']                     = 'Percentage (relative to image size)';
$_['text_fixed_size']                     = 'Fixed Size (pixels)';
$_['entry_watermark_status']              = 'Enable Watermark';
$_['entry_watermark_image']                = 'Watermark Image';
$_['entry_watermark_position']            = 'Watermark Position';
$_['entry_watermark_size_type']           = 'Size Type';
$_['entry_watermark_size_percentage']     = 'Watermark Size (%)';
$_['entry_watermark_size_fixed']          = 'Watermark Size (W x H)';
$_['help_watermark_status']               = 'Automatically add watermark to uploaded images';
$_['help_watermark_image']                = 'Select the watermark image file (PNG with transparency recommended)';
$_['help_watermark_position']             = 'Position where the watermark will be placed on images';
$_['help_watermark_size_type']            = 'Choose how to size the watermark: percentage (relative to image) or fixed pixels';
$_['help_watermark_size_percentage']      = 'Watermark size as percentage of the image (1-100%). Example: 20 means watermark will be 20% of image width';
$_['help_watermark_size_fixed']           = 'Fixed watermark size in pixels. Leave 0 for auto (maintains aspect ratio)';
$_['button_watermark_apply_existing']     = 'Apply to Existing Images';
$_['text_watermark_apply_existing']       = 'Apply the current watermark settings to all existing images in the image/catalog/ folder. Save your settings first. Images that already have a watermark will get a second watermark.';
$_['text_watermark_apply_progress']       = 'Processing %s of %s images...';
$_['text_watermark_apply_complete']       = 'Done. Watermark applied to %s images and %s cached thumbnails were cleared.';
$_['text_watermark_no_images']            = 'No images were found in image/catalog/.';
$_['error_watermark_not_configured']      = 'Enable watermark and choose a watermark image before running this tool.';
$_['error_watermark_image_missing']       = 'The selected watermark image file could not be found.';
$_['text_watermark_apply_skipped']        = '%s images were skipped because the files are not writable.';
$_['error_watermark_session']             = 'Could not start watermark batch. Please refresh the page and try again.';
